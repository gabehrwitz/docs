...
<AccordionGroup>
  ...
  <Accordion title="Sort" icon="arrow-down-a-z">
  ...
  <Accordion title="Deduplicate" icon="clone">
  ...
  <Accordion title="Add Column" icon="plus">
    Add new columns with default values or formulas.
  </Accordion>
  <Accordion title="Remove Column" icon="minus">
